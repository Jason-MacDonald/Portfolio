...
const About = () => {
    return (
        <div id="about" style={{ paddingTop: '200px', paddingBottom: '200px', backgroundColor: 'teal'}}>
                ...
                <div className="item">
                    ...
                    <div className="ui content">
                        ...
                        <div className="meta" style={{ color: 'white'}}>
                            <h2><i>Front-End Web Developer from Nelson, New Zealand.</i></h2>
                        </div>
                        <div className="description" style={{ color: 'white'}}>
                            <h3>I enjoy tackling complex problems and turning them into simple and beautiful interface designs. I also love the logic and structure of coding and always thrive to write elegant and efficient code using the latest technologies.</h3>
                        </div>
                        <br /><br />
                        <h1 className="ui header" style={{ color: 'white'}}>
                            Contact Details
